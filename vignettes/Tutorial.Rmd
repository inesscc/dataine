...
Then we must call the package, make sure the name is "inedata".
...
```{r, message=FALSE,warning=FALSE,results='hide'}
ene_small <- get_data(dataset = "ene", version = file, col_list = c("ano_trimestre","mes_central","fact_cal","cae_especifico"), save_where = "no_message")
```
```{r}
ene_small %>% head()
```
