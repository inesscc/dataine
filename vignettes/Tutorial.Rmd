...
[here](http://192.168.1.4:2000/docs).Below are the endpoints and a link to the documentation.
...
```{r, eval=FALSE}
http://192.168.1.4:2000/colnames
```
